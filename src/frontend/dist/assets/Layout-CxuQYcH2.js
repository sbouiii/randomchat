import { r as reactExports, j as jsxRuntimeExports } from "./index-BcORI3wC.js";
/**
...
function Layout({ children, withGradient = true }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen w-full overflow-hidden bg-background text-foreground font-body", children: [
    withGradient && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        "aria-hidden": "true",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 min-h-screen", children })
  ] });
}
export {
  Layout as L,
